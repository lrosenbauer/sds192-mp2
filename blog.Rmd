...
Notice how these graphs look very similar. This is likely due to the overall trend of incumbents winning more elections. We can see how common this trend is in the following graph:

# Ratio of winners and losers within incumbents and new candidates
```{r}
