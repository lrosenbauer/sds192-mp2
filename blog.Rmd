...
```{r}
<<<<<<< HEAD
ggplot(data=hc_stats_2, aes(x = n_contributions, y = total_contribution, color = ge_winner)) + geom_point(alpha = 3/10) + labs(list(title = "How Grass-Roots Are the Candidates?", x = "Number of Contributions", y = "Total Contributions")) + scale_color_discrete(labels = c("N" = "Lost", "W" = "Won"))

ggplot(data=hc_stats_2, aes(x = n_contributions, y = total_contribution, color = party)) + geom_point(alpha = 3/10)
=======
...
>>>>>>> c9c6545940605cf715b3b02c61a303f988cc7005
```
