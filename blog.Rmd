...
ggplot(data=hc_stats_2, aes(x = n_contributions, y = total_contribution, color = incumbent)) + geom_point(alpha = 5/10) + labs(list(title = "How Grass-Roots Are the Incumbents?", x = "Number of Contributions", y = "Total Contributions", color = "")) + scale_color_discrete(labels = c("TRUE" = "Incumbent", "FALSE" = "Non-Incumbent")) + scale_y_continuous(labels = dollar) + scale_color_pander()
```
