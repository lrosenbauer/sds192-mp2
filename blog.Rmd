...
```{r}
ggplot(data=hc_stats_2, aes(x = n_contributions, y = total_contribution, color = ge_winner)) + geom_point(alpha = 5/10) + labs(list(title = "Donations: How Many and How Big?", x = "Number of Contributions", y = "Total Contributions", color = "")) + scale_color_brewer(labels = c("N" = "Lost", "W" = "Won"), palette = "Accent") + scale_y_continuous(labels = dollar) + theme_hc()

ggplot(data=hc_stats_2, aes(x = n_contributions, y = total_contribution, color = incumbent)) + geom_point(alpha = 5/10) + labs(list(title = "How Grass-Roots Are the Incumbents?", x = "Number of Contributions", y = "Total Contributions", color = "")) + scale_y_continuous(labels = dollar) + scale_color_tableau(labels = c("TRUE" = "Incumbent", "FALSE" = "Non-Incumbent" )) + theme_hc()
```
